...
const FloatingTechIcons = () => {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {/* OG-inspired gradient orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-pulse" style={{ boxShadow: '0 0 200px rgba(255, 69, 0, 0.3)' }} />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s', boxShadow: '0 0 200px rgba(255, 215, 0, 0.3)' }} />
      <div className="absolute top-1/2 right-1/3 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s', boxShadow: '0 0 200px rgba(255, 107, 53, 0.3)' }} />
    </div>
  )
}
